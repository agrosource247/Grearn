...
const Trade = ({ navigation }) => {
  ...
  const products = [
    { name: "Pepper", price: "#250000", type: "Vegetables", percentage: "25%" },
    { name: "Melon", price: "#300000", type: "Crops", percentage: "30%" },
    { name: "Soybeans", price: "#150000", type: "Legumes", percentage: "20%" },
    { name: "Ginger", price: "#150000", type: "Herbaceous", percentage: "20%" },
    {
      name: "Honey",
      price: "#150000",
    ...
    { name: "Maize", price: "#100000", type: "Cereals", percentage: "15%" },
  ];
