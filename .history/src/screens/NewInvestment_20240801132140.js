      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.newInvestment}>
          ...
          <View style={styles.investmentOption}>
            ...
            <Text style={styles.optionDescription}>
              <Text style={styles.descriptionText}>
                Pepper offers a stable and potentially lucrative opportunity for
          ...
          <View style={styles.investmentOption}>
            ...
            <Text style={styles.optionDescription}>
              <Text style={styles.descriptionText}>
                Melon offers a stable and potentially lucrative opportunity for
                both seasoned and novice investors.
              </Text>
              <Text style={styles.seeMore}>See more</Text>
            </Text>
          ...
          <View style={styles.investmentOption}>
            ...
            <Text style={styles.optionDescription}>
              <Text style={styles.descriptionText}>
                Honey offers a stable and potentially lucrative opportunity for
                both seasoned and novice investors.
              </Text>
              <Text style={styles.seeMore}>See more</Text>
            </Text>
