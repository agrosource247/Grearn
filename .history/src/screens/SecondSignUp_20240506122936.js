          ...
          <View style={[styles.firstNameWrapper]}>
            <TextInput
              style={[
                ...
                firstname && styles.focusedInput,
              ]}
              onChangeText={setFirstName}
              value={firstname}
              placeholder="First name"
              onFocus={() => setFirstName(true)} // Set isFocused to true when TextInput is focused
              onBlur={() => setFirstName(false)} // Set isFocused to false when TextInput loses focus
              color="black"
            />
            ...
            <View style={[styles.lastNameWrapper]}>
              <TextInput
                style={[
                  ...
                  styles.nameTypo,
                  styles.nameWrapperLayout,
                  lastname && styles.focusedInput,
                ]}
                onChangeText={setLastName}
                value={lastname}
                placeholder="Last name"
                onFocus={() => setLastName(true)} // Set isFocused to true when TextInput is focused
                onBlur={() => setLastName(false)} // Set isFocused to false when TextInput loses focus
                color="black"
              />
            </View>
          </View>
