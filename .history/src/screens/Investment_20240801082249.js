...
const styles = StyleSheet.create({
  ...
  headerContainer: {
    paddingHorizontal: 15, // Ensure padding is applied if needed
  },
  ...
  investments: {
    ...
    fontWeight: "600",
    marginLeft: 8, // Adjust spacing between image and text
  },
  activePackage: {
    fontSize: FontSize.size_xs,
    color: Color.colorDimgray_600,
    fontWeight: "500",
    marginTop: 21, // Margin between the header and the active package text
  },
  investmentChild: {
    height: 148,
    width: "90%",
