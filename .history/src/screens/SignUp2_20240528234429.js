...
import { Color, Border, FontSize, FontFamily } from "../";
import {
      ...
      <ScrollView>
        <View style={styles.signUp}>
          ...
          <Text style={[styles.haveAnAccountContainer, styles.cancelPosition]}>
            ...
            <Text style={[styles.logIn, styles.resendTypo]}>Log in</Text>
          </Text>
          <Text
...
+2349049733613`}</Text>
          ...
          <Text
            style={[styles.bySigningUpyouContainer, styles.pleaseEnterTheTypo]}
          >
            <Text
