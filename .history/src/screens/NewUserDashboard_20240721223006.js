...
const imageData = [
  { source: require("../assets/frame-25.png"), text: "Text for Image 1" },
  { source: require("../assets/frame-37.png"), text: "Text for Image 2" },
  { source: require("../assets/frame-36.png"), text: "Text for Image 3" },
  { source: require("../assets/frame-33.png"), text: "Text for Image 4" },
  { source: require("../assets/frame-35.png"), text: "Text for Image 5" },
];
const ImageList = () => {
  return (
