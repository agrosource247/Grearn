            ...
            >
              ...
              >
                <Text style={styles.principal}>
                  Principal:{" "}
                  <Text style={styles.amount}>#{transactions.product}</Text>
                </Text>
                <Text style={styles.profit}>
                  Profit:
                  <Text style={styles.amount}>#{transactions.profit}</Text>
                </Text>
              </View>
              <View
                style={{
              ...
              >
                <Text style={styles.roi}>
                  ROI: <Text style={styles.monthly}>{transactions.roi}</Text>
                </Text>
                <Text style={styles.geoLocation}>
                  Geo-location:
                  <Text style={styles.location}>{transactions.location}</Text>
                </Text>
              </View>
              <View
                style={{
              ...
              >
                <Text style={styles.harvestPeriod}>
                  Harvest period:{" "}
                  <Text style={styles.duration}>{transactions.duration}</Text>
                </Text>
                <View style={{ flexDirection: "row" }}>
                  <Text style={styles.insurance}>Insurance:</Text>
                  <View style={styles.activeWrapper}>
                    <Text style={styles.active}>
                      {transactions.insurance ? "Active" : "Not Active"}
                    </Text>
                  </View>
                </View>
              </View>
