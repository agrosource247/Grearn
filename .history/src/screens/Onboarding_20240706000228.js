...
const ImageSlider = () => {
  ...
  const images = [
  { source=require("../assets/undraw_invest_re_8jl5.png"),    width: 300, // Replace with your desired width
    height: 200,},
{source=require("../assets/undraw_finance_re_gnv2.png"),    width: 300, // Replace with your desired width
  height: 200,},
   {  source=require("../assets/undraw_online_payments_re_y8f2 1.png"),    width: 300, // Replace with your desired width
    height: 200,}
