    ...
    <GestureHandlerRootView>
      <ScrollView>
        <View style={styles.signUp}>
          ...
          <GestureHandlerRootView style={[styles.firstNameWrapper]}>
            <TextInput
              style={[
                styles.firstName,
                styles.nameTypo,
          ...
          <GestureHandlerRootView
            style={[styles.omitoyinayomide20gmailcomWrapper]}
          >
            <Text
              style={[
                styles.emailAddress,
            ...
            <TextInput style={[styles.text1Position, styles.wrapperLayout]}>
              Omitoyinayomide20@gmail.com
            </TextInput>
          </GestureHandlerRootView>
          <GestureHandlerRootView style={[styles.dee002Wrapper]}>
            <Text style={[styles.username, styles.usernamePosition]}>
              Username
            </Text>
            <GestureHandlerRootView style={[styles.lastNameWrapper]}>
              <TextInput
                style={[
                  styles.lastName,
                  styles.nameTypo,
            ...
            <FirstSignUp />
            <TextInput style={[styles.dee002, styles.wrapperLayout]}>
              Dee002
            </TextInput>
          </GestureHandlerRootView>
          <GestureHandlerRootView
          ...
          <View style={{ top: 150 }}>
            <Pressable style={styles.proceedWrapper}>
              <Text
