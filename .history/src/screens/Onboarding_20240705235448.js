...
const ImageSlider = () => {
  ...
  const images = [
    ...
    require("../assets/undraw_finance_re_gnv2.png"), // Replace with your actual image path
    require("../assets/undraw_online_payments_re_y8f2 1.png"), // Replace with your actual image path
  ];
