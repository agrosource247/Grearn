...
const FirstSignUp = ({ navigation }) => {
  ...
  const checkFields = () => {
    setIsFilled(
      phoneNumber.length === phone && countryNumber.length === country
    );
  };
  const handleSignIn = async () => {
    ...
    if (countryNumber.length !== country) {
      Alert.alert(
              ...
              <View style={[styles.container]}>
                <TextInput
                  ...
                  onChangeText={(text) => {
                    ...
                    if (text.startsWith("+")) {
                      // If it does, set the countryNumber to the entered text
                      setCountryNumber(text);
                    } else {
                      // If not, prepend the "+" sign to the entered text and set it as countryNumber
                      setCountryNumber("+" + text);
                    }
                  }}
                  keyboardType="numeric" // Use keyboardType prop instead of type
