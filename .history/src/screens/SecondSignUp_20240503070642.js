...
const SecondSignUp = ({ navigation }) => {
  ...
  // Update the state variables and check if all fields are filled whenever the text inputs change
  const handleInputChange = (inputName, text) => {
    ...
    // Check if all fields are filled whenever any text input changes
