    ...
    <GestureHandlerRootView>
      <ScrollView>
        <View style={styles.addNewCard}>
          ...
          <TextInput style={[styles.cvvWrapper, styles.cvvwrapperLayout]}>
        ...
        <View style={[styles.incorrectCardNumber, styles.savePosition]}>
          <Text style={[styles.savePosition1, (style = { color: "#ff3434" })]}>
            Incorrect expiry date
          </Text>
          <Image
            style={[styles.icoutlineInfoIcon, styles.pleaseEnterCardPosition]}
            contentFit="cover"
