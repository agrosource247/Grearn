...
const NewUserDashboard = ({ navigation }) => {
	...
	const modalContent = [
		{
			subText: "Trade crop price changes in the six geopolitical zones in Nigeria, and get daily income as price rises",
			image: require("../assets/select_trade.png"),
			buttonText: "Trade now",
		},
		{
			subText: "Invest with us and don’t worry about price changes. Get fixed crop savings for 2% monthly and 24% yearly.",
	...
	return (
		<GestureHandlerRootView>
			...
			>
				{users.length > 0 ? (
					<View style={styles.newUserDashboard}>
						...
						<Text style={[styles.liveStocks]}></Text>
						<SlideScreen />
						<SlidingBar />
						<Modal visible={isModalVisible} transparent animationType="fade">
							<View style={styles.modalContainer}>
								<View style={styles.modalContent}>
									...
									<Image contentFit="cover" source={require("../assets/select_trade.png")} style={{ marginTop: 72, width: 268, height: 165 }} />
									...
									<View style={{ flexDirection: "row", marginTop: 10 }}>
										<View
											style={{
												...
												height: scale(9),
												borderRadius: scale(9 / 2),
												backgroundColor: contentIndex === 0 ? Color.colorYellowgreen_100 : Color.colorA,
												marginRight: scale(5),
											}}
										></View>
										<View
											style={{
												...
												height: scale(9),
												borderRadius: scale(9 / 2),
												backgroundColor: contentIndex === 1 ? Color.colorYellowgreen_100 : Color.colorA,
											}}
										></View>
									</View>
								</View>
						...
						>
							{imageData.map((item, index) => (
								<ImageWithText key={index} imageSource={item.source} text={item.text} text2={item.text2} text3={item.text3} />
							))}
						</View>
					</View>
				) : loading ? (
			...
			<View style={{ flex: 1 }}>{/* <BottomNavigation /> */}</View>
		</GestureHandlerRootView>
	);
};
