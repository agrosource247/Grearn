		...
		<GestureHandlerRootView style={styles.container}>
			<ScrollView contentContainerStyle={styles.scrollViewContainer}>
				<View style={styles.myCardsContainer}>
					...
					>
						<LinearGradient style={[styles.card]} locations={[0, 0.49, 1]} colors={["#006dbc", "#007ad2", "#0067b2"]}>
					...
					>
						<LinearGradient style={[styles.card]} locations={[0, 0.86, 1]} colors={["#8000bc", "#9a05b3", "#8000bc"]}>
							...
							<Image style={[styles.logosmastercardIcon]} contentFit="cover" source={require("../assets/logosmastercard.png")} />
