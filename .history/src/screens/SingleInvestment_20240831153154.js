...
const SingleInvestment = ({ route, navigation }) => {
  const { transaction } = route.params; // Access the transaction data
            ...
            <View style={styles.detailsContainer}>
              <View style={styles.detailsRow}>
                <Text style={styles.principal}>
                  Principal:{" "}
                  <Text style={styles.amount}>#{transaction.principal}</Text>
                </Text>
                <Text style={styles.profit}>
                  Profit:{" "}
                  <Text style={styles.amount}>#{transaction.profit}</Text>
                </Text>
              </View>
              <View style={styles.detailsRow}>
                <Text style={styles.roi}>
                  ROI: <Text style={styles.monthly}>{transaction.roi}</Text>
                </Text>
              ...
              <View style={styles.detailsRow}>
                <Text style={styles.harvestPeriod}>
                  Harvest Period:{" "}
                  <Text style={styles.duration}>{transaction.duration}</Text>
                </Text>
                <View style={styles.insuranceWrapper}>
                  <Text style={styles.insuranceText}>
                    {transaction.insurance ? "Active" : "Not Active"}
                  </Text>
                </View>
              </View>
            </View>
