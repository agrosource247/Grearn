...
const MyCards = ({ navigation }) => {
  return (
    <GestureHandlerRootView contentContainerStyle={{ alignItems: "center" }}>
      <ScrollView>
        <View style={styles.myCards}>
          ...
          >
            ...
            <Text style={[styles.omitoyinDavidAyomide, styles.omitoyinLayout]}>
          ...
          >
            ...
            <Image
              ...
              source={require("../assets/vuesaxlinearwifi.png")}
            />
            <Text style={[styles.omitoyinDavidAyomide1, styles.omitoyinLayout]}>
              Omitoyin David Ayomide
            </Text>
          </LinearGradient> */}
          <Pressable
