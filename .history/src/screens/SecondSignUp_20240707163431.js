    ...
    <GestureHandlerRootView>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View style={styles.signUpContainer}>
          ...
          <View
            styles={{ borderRadius: 6, color: "blue", width: 100, height: 100 }}
          >
            {/* style={styles.firstlastNameWrapper} */}
            <TextInput
              style={[styles.firstName, styles.firstNameWrapperLayout]}
            ...
            <TextInput
              ...
              color="black"
            />
            <View>{/* style={styles.lastNameWrapper} */}</View>
          </View>
              ...
              <View style={[styles.frame2]}>
                ...
                <View style={styles.frame12}>
                  ...
                  <View style={styles.container}>
                    ...
                    <TextInput
                      style={[styles.countrywrapperBorder]}
                      value={country}
