...
const SingleInvestment = () => {
  ...
  const { investment } = route.params; // Access the investment data
          ...
          <View style={styles.detailsContainer}>
            <View style={styles.detailsRow}>
              <Text style={styles.principal}>
                Principal:{" "}
                {/* <Text style={styles.amount}>#{investment.minimum_invest}</Text> */}
              </Text>
              <Text style={styles.profit}>
                Profit: <Text style={styles.amount}>#{investment.profit}</Text>
              </Text>
            </View>
            <View style={styles.detailsRow}>
            ...
            <View style={styles.detailsRow}>
              <Text style={styles.harvestPeriod}>
                Harvest Period:{" "}
                {/* <Text style={styles.duration}>{investment.harvest_period}</Text> */}
              </Text>
              <View style={styles.insuranceWrapper}>
                <Text style={styles.insuranceText}>
                  {/* {investment.insurance ? "Active" : "Not Active"} */}
                </Text>
              </View>
            </View>
          </View>
