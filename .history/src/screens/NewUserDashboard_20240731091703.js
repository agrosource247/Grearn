              ...
              <Modal visible={isModalVisible} transparent animationType="slide">
                <View style={styles.modalContainer}>
                  <View style={styles.modalContent}>
                    ...
                    <Text
                      style={{ marginTop: 63.23, fontSize: FontSize.size_sm }}
                    >
                      Trade crop price changes in the six <br />
                      geopolitical zones in Nigeria, and get daily
                      <br /> income as price rises
                    </Text>
                    <View
                      style={{
                    ...
                    >
                      <Button title="Trade now" onPress={toggleTradeNow} />
                    </View>
                  </View>
                </View>
              </Modal>
