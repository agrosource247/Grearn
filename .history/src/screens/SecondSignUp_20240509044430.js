  ...
  const handleSignUpData = async () => {
    try {
      ...
      if (response.status === "success") {
        ...
        // Navigate to the signup2 screen upon successful sign-up
        ...
        <View style={styles.signUp}>
          ...
          <View style={[styles.firstNameWrapper]}>
            <TextInput
              ...
              onChangeText={setFirstName} // Update firstName state with new value entered by user
              value={firstname}
            ...
            <View style={[styles.lastNameWrapper]}>
              <TextInput
                ...
                onChangeText={setLastName} //Update last name state with new value entered by user
                value={lastname}
          ...
          <View style={[styles.dee002Wrapper]}>
            ...
            <TextInput
              ...
              onChangeText={setUserName} // update Username state with new value entered by user
              value={username}
              placeholder="Dee002"
              color="black"
            />
          ...
          <View style={[styles.wrapper, styles.wrapperLayout]}>
            ...
            <TextInput style={[styles.TextInput16]}
                onChangeText={setUserName} // update Username state with new value entered by user
              value={}
