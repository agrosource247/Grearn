    ...
    <GestureHandlerRootView>
      <ScrollView>
        <View style={styles.packageInfo}>
          ...
          <ImageBackground
            style={[styles.packageInfoInner, styles.packagePosition]}
            resizeMode="cover"
          ...
          <Text style={[styles.harvestPeriod, styles.insuranceTypo]}>
            Harvest period:
          </Text>
          <Text
            style={[styles.minimumInvest, styles.insuranceTypo]}
          >{`Minimum invest: `}</Text>
          <Text style={[styles.insurance, styles.insuranceTypo]}>
            Insurance:
          </Text>
          <Text style={[styles.geoLocation, styles.roiTypo]}>
            Geo-location:
          </Text>
          ...
          >{`Pepper offers a stable and potentially lucrative opportunity for both seasoned and novice investors. Pepper offers a stable and potentially lucrative opportunity for both seasoned and novice investors. Pepper offers a stable and potentially lucrative opportunity for both seasoned and novice investors. `}</Text>
          ...
          <View style={[styles.availableWrapper, styles.upBars1Position]}>
            <Text style={[styles.available, styles.availablePosition]}>
              Available
            </Text>
          </View>
          <Image
            style={[
              styles.vuesaxlinearstarIcon,
              styles.vuesaxlinearstarIconPosition,
            ]}
            contentFit="cover"
            source={require("../assets/vuesaxlinearstar.png")}
          />
          <Image
            style={[
              styles.vuesaxlinearstarIcon1,
              styles.vuesaxlinearstarIconPosition,
            ]}
            contentFit="cover"
            source={require("../assets/vuesaxlinearstar.png")}
          ...
          <Image
            style={[
              styles.vuesaxlinearstarIcon4,
              styles.vuesaxlinearstarIconPosition,
            ]}
            contentFit="cover"
            source={require("../assets/vuesaxlinearstar1.png")}
          />
          <View style={styles.investNowWrapper}>
            <Text style={[styles.investNow, styles.availablePosition]}>
              Invest now
            </Text>
          </View>
        </View>
