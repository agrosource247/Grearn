...
const NewUserDashboard = ({ navigation }) => {
  ...
  const [isTradeModalVisible, setIsTradeModalVisible] = React.useState(false);
      ...
      >
        {users.length > 0 ? (
          <View style={styles.newUserDashboard}>
            ...
            <Button title="Open Trade Modal" onPress={toggleTradeModal} />

            <Modal
              animationType="slide"
              transparent={false}
              visible={isTradeModalVisible}
              onRequestClose={toggleTradeModal}
            >
              <View style={modalStyles.centeredView}>
                <View style={modalStyles.modalView}>
                  <Text style={modalStyles.modalText}>Trade</Text>
                  <Pressable
                    style={[modalStyles.button, modalStyles.buttonClose]}
                    onPress={toggleTradeModal}
                  >
