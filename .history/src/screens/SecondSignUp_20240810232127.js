		...
		<GestureHandlerRootView>
			<ScrollView showsVerticalScrollIndicator={false}>
				...
				<View style={styles.signUpContainer}>
					...
					<Text style={[styles.letsGetYouTypo]}>Let's get you started with your free account</Text>

					<View>
						<Text style={[styles.yourPosition]}>Your full name (as shown on your ID)</Text>
					...
					<View style={styles.omitoyinayomide20gmailcomWrapper}>
						...
						<View style={{ justifyContent: "center", alignContent: "center" }}>
							...
							<Text style={[styles.yourPasswordMust]}>Your password must have a minimum of 8 characters, which should include an uppercase, lowercase, a number, and a special character</Text>
