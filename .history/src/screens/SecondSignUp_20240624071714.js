  ...
  <View>
    ...
    <View style={[styles.haveAnAccountContainer, styles.cancelPosition]}>
      <View style={styles.haveAnAccount}>
        <View style={{ flexDirection: "row", alignItems: "center", left: 235 }}>
...
const SecondSignUp = ({ navigation }) => {
  ...
  const handleSignUpData = async () => {
    ...
    if (!cpassword) return alert("Confirm Password field is required.");
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View style={styles.signUp}>
          ...
          <View style={styles.omitoyinayomide20gmailcomWrapper}>
            ...
            <TextInput
              style={[styles.text1Position, styles.emailwrapperLayout]}
          ...
          <View style={styles.dee002Wrapper}>
            <View>
              ...
              <TextInput
                style={[styles.dee002, styles.userNamewrapperLayout]}
          ...
          <View style={[styles.dobwrapper, styles.dobwrapperLayout]}>
