...
const styles = StyleSheet.create({
  ...
  lastNameWrapper: {
    left: width * 0.54, // Adjusted left position using a percentage of screen width
    width: width * 0.155, // Adjusted width using a percentage of screen width
    borderWidth: 1,
    borderColor: Color.colorLightgray_100,
    borderStyle: "solid",
    top: height * -0.004, // Adjusted top position using a percentage of screen height
  },
  yourFullNameas: {
