			...
			<ScrollView>
				<View style={styles.signIn}>
					...
					<View style={[styles.omitoyinayomide20gmailcomWrapper]}>
						...
						<TextInput value={email} style={[styles.enterPasswordPosition, styles.EmailwrapperLayout]} placeholder="omitoyinayomide20gmailcom" onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" />
					</View>
					...
					<View style={{ top: -30 }}>
						<Text style={[styles.dontHaveAnContainer, styles.cancelTypo]}>
							<Pressable onPress={handleForgotPwdPress}>
								<Text style={[styles.signUp, styles.dontHaveContainer]}>Forgot Password?</Text>
							</Pressable>
						</Text>
					</View>
				</View>
