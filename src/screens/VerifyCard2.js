...
+2349049733613`}</Text>
        ...
        <View
          style={[styles.yourCardHasBeenAddedSucceParent, styles.savePosition]}
        >
          <Text style={[styles.yourCardHas, styles.completeTypo]}>
          ...
          <Image
            style={[styles.fa6SolidthumbsUpIcon, styles.savePosition]}
            contentFit="cover"
...
const styles = StyleSheet.create({
  ...
  yourCardHasBeenAddedSucceParent: {
    marginLeft: -137,
    top: 247,
