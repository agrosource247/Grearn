    ...
    <GestureHandlerRootView>
      <ScrollView>
        <View style={styles.insufficientFunds}>
          ...
          <View
            style={[
              styles.investmentSuccessfulParent,
              styles.investNowPosition,
            ]}
          >
            <Text style={[styles.investmentSuccessful, styles.completeTypo]}>
              Investment successful
            </Text>
            <View style={[styles.completeWrapper, styles.wrapperBg]}>
              <Text style={[styles.complete, styles.completeTypo]}>
                Complete
              </Text>
            </View>
            <Image
              style={[styles.fa6SolidthumbsUpIcon, styles.investNowPosition]}
              contentFit="cover"
              source={require("../assets/fa6solidthumbsup.png")}
            />
          </View>
        </View>
      </ScrollView>
