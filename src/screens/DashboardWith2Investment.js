    ...
    <GestureHandlerRootView>
      <ScrollView>
        <View style={styles.dashboardWith2Investment}>
          ...
          />
          <Image
            style={styles.dashboardWith2InvestmentChild}
            contentFit="cover"
          ...
          >
            <Text style={[styles.investmentPackage, styles.gingerFlexBox]}>
              Investment package
            </Text>
            ...
            <ScrollView horizontal={true}>
              <Image
                style={[
                  styles.dashboardWith2InvestmentChild8,
              ...
              <Image
                style={[
                  styles.dashboardWith2InvestmentChild9,
                  styles.dashboardChildLayout,
                ]}
                contentFit="cover"
              ...
              <Image
                style={[
                  styles.dashboardWith2InvestmentChild10,
                  styles.dashboardChildLayout,
                ]}
                contentFit="cover"
          ...
          <Image
            style={[
              styles.dashboardWith2InvestmentItem,
              styles.dashboardLayout1,
            ]}
            contentFit="cover"
          ...
          <Image
            style={[
              styles.dashboardWith2InvestmentInner,
          ...
          <Image
            style={[
              styles.dashboardWith2InvestmentChild1,
              styles.dashboardChildLayout1,
            ]}
            contentFit="cover"
          ...
          <Image
            style={[
              styles.dashboardWith2InvestmentChild2,
              styles.dashboardLayout1,
            ]}
            contentFit="cover"
          ...
          <Image
            style={[
              styles.dashboardWith2InvestmentChild3,
              styles.dashboardLayout,
            ]}
            contentFit="cover"
          ...
          <Image
            style={[
              styles.dashboardWith2InvestmentChild4,
          ...
          <Image
            style={[
              styles.dashboardWith2InvestmentChild5,
              styles.dashboardChildLayout1,
            ]}
            contentFit="cover"
          ...
          <Image
            //green up arrow
            style={[
              styles.dashboardWith2InvestmentChild6,
          ...
          <Image
            //red down arrow
            style={[
              styles.dashboardWith2InvestmentChild7,
              styles.iconChildLayout,
            ]}
            contentFit="cover"
          ...
          <Image
            style={styles.dashboardWith2InvestmentChild11}
            contentFit="cover"
