		...
		<GestureHandlerRootView style={styles.container}>
			<View style={styles.background}>
				...
				<View style={styles.omitoyinayomide20gmailcomWrapper}>
					...
					<TextInput style={styles.textInput} onChangeText={setEmail} value={email} placeholder="Omitoyinayomide20@gmail.com" color="black" />
				</View>
...
const styles = StyleSheet.create({
	...
	frameCreate: {
		...
		marginLeft: screenWidth * -0.27, // Adjusted for responsive design
	},
	createPosition: {
