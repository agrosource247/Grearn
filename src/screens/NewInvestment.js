				...
				<View style={styles.newInvestment}>
					...
					<View style={styles.header}>
						<Pressable onPress={() => navigation.navigate("Investment")}>
							<Image style={styles.backIcon} contentFit="cover" source={require("../assets/vuesaxlineararrowleft.png")} />
						</Pressable>
					...
					<View style={styles.investmentOption}>
						<View style={styles.optionContainer}>
							<Image style={styles.optionImage} contentFit="cover" source={require("../assets/frame-56.png")} />
							<View style={styles.optionDetails}>
								...
								<Text style={styles.optionDescription}>
									<Text style={styles.descriptionText}>Pepper offers a stable and potentially lucrative opportunity for both seasoned and novice investors.</Text>
					...
					<View style={styles.investmentOption}>
						<View style={styles.optionContainer}>
							<Image style={styles.optionImage} contentFit="cover" source={require("../assets/frame-561.png")} />
							<View style={styles.optionDetails}>
								...
								<Text style={styles.optionInfo}>Info</Text>
								<Text style={styles.optionDescription}>
									<Text style={styles.descriptionText}>Melon offers a stable and potentially lucrative opportunity for both seasoned and novice investors.</Text>
									<Text style={styles.seeMore}>See more</Text>
								</Text>
							</View>
						</View>
					...
					<View style={styles.investmentOption}>
						<View style={styles.optionContainer}>
							<Image style={styles.optionImage} contentFit="cover" source={require("../assets/frame-562.png")} />
							<View style={styles.optionDetails}>
								...
								<Text style={styles.optionInfo}>Info</Text>
								<Text style={styles.optionDescription}>
									<Text style={styles.descriptionText}>Honey offers a stable and potentially lucrative opportunity for both seasoned and novice investors.</Text>
									<Text style={styles.seeMore}>See more</Text>
								</Text>
							</View>
						</View>
