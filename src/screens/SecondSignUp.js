		...
		<GestureHandlerRootView>
			<ScrollView scrollContainer={{ flexGrow: 1 }}>
				<View style={styles.signUp}>
					...
					<Text style={[styles.letsGetYou, styles.letsGetYouTypo]}>Lets get you started with your free account</Text>
					<View style={{ left: -30 }}>
								...
								<View>
									...
									<View style={styles.frame12}>
										<View style={[styles.wrapper]}>
											<TextInput style={[styles.text1, styles.RightTextTypo]} placeholder="9049733613" value={phone} onChangeText={setPhone} keyboardType="numeric" color="black" />
										</View>
										<View style={[styles.container]}>
											<TextInput style={[styles.text1, styles.textTypo, styles.wrapperBorder]} value={country} onChangeText={setCountry} placeholder="+234" maxLength={4} keyboardType="numeric" />
										</View>
									</View>
								</View>
							</View>
