...
const MyCancel2 = ({ navigation }) => (
	<View>
		<Text style={[styles.cancel, styles.cancelPosition]} onPress={() => navigation.navigate("Onboarding")}>
			Cancel
		</Text>
		...
		<GestureHandlerRootView>
			<ScrollView contentContainerStyle={{ flexGrow: 1 }}>
				<View style={styles.signUp}>
					...
					<Text style={[styles.letsGetYou, styles.letsGetYouTypo]}>Let's get you started with your free account</Text>

					<View style={{ left: -30 }}>
						<Text style={[styles.yourFullNameas, styles.yourPosition]}>Your full name (as shown on your ID)</Text>
					</View>
					...
					<View style={styles.omitoyinayomide20gmailcomWrapper}>
						<Text style={[styles.emailAddress, styles.emailformat]}>Email Address</Text>
						<TextInput style={[styles.text1Position, styles.wrapperLayout]} onChangeText={setEmail} value={email} placeholder="Omitoyinayomide20@gmail.com" color="black" />
					</View>
					...
					<View style={styles.dee002Wrapper}>
						...
						<View style={[styles.frame2, styles.frameLayout1]}>
							<View style={styles.frame11}>
								<Text style={[styles.country, styles.countryPosition]}>Country</Text>
					...
					<View style={[styles.dobwrapper, styles.wrapperLayout]}>
						<Text style={[styles.dateOfBirth, styles.datePosition]}>Date of Birth</Text>
						<TextInput style={styles.TextInput16} onChangeText={setDob} value={dob} placeholder="16/09/1995" color="black" />
					</View>
					...
					<View style={styles.letsYou}>
						<Text>
							<Text style={styles.haveAnAccount1}>By signing Up, you agree to our </Text>
