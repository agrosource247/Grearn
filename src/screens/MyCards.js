			...
			<ScrollView>
				<View style={styles.myCards}>
					...
					<Pressable onPress={() => navigation.navigate("NewUserDashboard")}>
						<Image style={styles.vuesaxlineararrowLeftIcon} contentFit="cover" source={require("../assets/vuesaxlineararrowleft.png")} />
					</Pressable>

					<Text style={styles.myCard}>My Card</Text>
					<Text style={styles.manageCards}>Manage cards</Text>
					<LinearGradient style={[styles.parent, styles.groupLayout]} locations={[0, 0.49, 1]} colors={["#006dbc", "#007ad2", "#0067b2"]}>
						<Text style={styles.text}>{`.... .... .... `}</Text>
						<Text style={[styles.text1, styles.textTypo]}>4561</Text>
						<Text style={[styles.text2, styles.textTypo]}>02/27</Text>
						<Text style={[styles.omitoyinDavidAyomide, styles.omitoyinLayout]}>Omitoyin David Ayomide</Text>
						<Text style={[styles.wemaBank, styles.ubaTypo]}>Wema Bank</Text>
						<Image style={[styles.logosmastercardIcon, styles.cardsParentLayout]} contentFit="cover" source={require("../assets/logosmastercard.png")} />
						<View style={[styles.cvvWrapper, styles.cvvLayout]}>
							<Text style={[styles.cvv, styles.cvvPosition]}>CVV</Text>
						</View>
						<Image style={styles.vuesaxlinearwifiIcon} contentFit="cover" source={require("../assets/vuesaxlinearwifi.png")} />
					</LinearGradient>
					<LinearGradient style={[styles.group, styles.groupLayout]} locations={[0, 0.86, 1]} colors={["#8000bc", "#9a05b3", "#8000bc"]}>
						<Text style={styles.text}>{`.... .... .... `}</Text>
						<Text style={[styles.text1, styles.textTypo]}>4561</Text>
						<Text style={[styles.text2, styles.textTypo]}>02/27</Text>
						...
						<Image style={styles.vuesaxlinearwifiIcon} contentFit="cover" source={require("../assets/vuesaxlinearwifi.png")} />
						<Text style={[styles.omitoyinDavidAyomide1, styles.omitoyinLayout]}>Omitoyin David Ayomide</Text>
					</LinearGradient>
					<Pressable
						style={styles.addNewCardWrapper}
						onPress={() => {
