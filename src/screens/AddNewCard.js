		...
		<GestureHandlerRootView>
			<ScrollView>
				<View style={styles.addNewCard}>
					...
					<TextInput style={[styles.enterYourCardNumberWrapper, styles.enterCardLayout]}>
						<Text style={[styles.enterYourCard, styles.enterCardTypo]}>Enter your card number</Text>
					</TextInput>
					<TextInput style={[styles.enterCardPinWrapper, styles.enterCardLayout]}>
						<Text style={[styles.enterCardPin, styles.enterCardTypo]}>Enter card pin</Text>
					</TextInput>
					<TextInput style={[styles.expiryDateWrapper, styles.wrapperLayout]}>
						<Text style={[styles.expiryDate, styles.enterCardTypo]}>Expiry date</Text>
					</TextInput>
					...
					<Text style={[styles.byProvidingYour, styles.savePosition]}>By providing your card information, you authorize Grearn to bind your card in accordance with Grearn terms and conditions</Text>
				</View>
			</ScrollView>
		</GestureHandlerRootView>
	);
